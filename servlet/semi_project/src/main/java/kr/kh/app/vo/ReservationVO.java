...
public class ReservationVO {
	private int  re_s_count, re_m_count, re_l_count, re_price;
	private int re_real_price, re_use_point, re_add_point;
	private String re_me_id, re_num, re_date, re_end_date, re_state;
	
	public ReservationVO(String re_num, int re_s_count, int re_m_count, int re_l_count, int re_price, int re_real_price,
