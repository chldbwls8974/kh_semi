	...
	<div class="container mt-5">
		...
		<form action="<c:url value='/size/update'/>" method="post"
			...
			<div class="form-group">
				<label>소형</label> <input type="number" class="form-control"
					name="si_min_kg_s" placeholder="${sSize.si_min_kg}" min="0"
					max="100" required>
			</div>
			<div class="form-group">
				<label>중형</label> <input type="number" class="form-control"
					name="si_min_kg_m" placeholder="${mSize.si_min_kg}" min="1"
					max="100" required>
			</div>
			<div class="form-group">
				<label>대형</label> <input type="number" class="form-control"
					name="si_min_kg_l" placeholder="${lSize.si_min_kg}" min="1"
					max="100" required>
			</div>
