...
INSERT INTO `member` VALUES ('ADMIN','일반','ADMIN','ADMIN','ADMIN','010-1111-1111',0,'ADMIN',0),('asdqwe123','vip','asdqwe123!','asd','서울시 강서구','1212222',10212,'USER',433),('qwe','vip','qwe','홍길동','서울시 강남구','010-1234-1234',11900,'USER',0),('user001','일반','user001','이름을 수정','주소를 수정','연락처를 수정',500,'USER',0);
