...
CREATE TABLE `point` (
  ...
  CONSTRAINT `point_to_member` FOREIGN KEY (`po_me_id`) REFERENCES `member` (`me_id`)
...
INSERT INTO `point` VALUES (40,350,'호텔 결제에 의한 적립','test0926','test09262023-09-27test0926001'),(41,-150,'호텔 결제시 포인트 사용에 의한 차감','test0926','test09262023-09-27test0926002'),(42,67,'호텔 결제에 의한 적립','test0926','test09262023-09-27test0926002');
...
-- Dump completed on 2023-09-26 17:49:47
