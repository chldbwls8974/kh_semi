...
INSERT INTO `member` VALUES ('ADMIN','일반','ADMIN','ADMIN','ADMIN','010-1111-1111',0,'ADMIN',0),('asdqwe123','일반','asdqwe123!','asd','서울시 강서구','1212222',10212,'USER',433),('qwe','vip','qwe','홍길순','주소를 수정','01012312311',29570,'USER',587),('user001','일반','user001','이름을 수정','주소를 수정','연락처를 수정',500,'USER',300);
