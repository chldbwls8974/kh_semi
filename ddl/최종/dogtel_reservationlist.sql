...
CREATE TABLE `reservationlist` (
  ...
  KEY `dog_to_rl_idx` (`rl_d_num`),
  CONSTRAINT `dog_to_rl` FOREIGN KEY (`rl_d_num`) REFERENCES `dog` (`d_num`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `reservationlist` VALUES (66,'test1234001',8,'test12342023-09-27test1234001'),(67,'test1234002',9,'test12342023-09-27test1234001'),(68,'test1234002',9,'test12342023-09-29test1234002'),(69,'test1234001',8,'test12342023-09-29test1234001'),(70,'test0926001',8,'test09262023-09-27test0926001'),(71,'test0926002',13,'test09262023-09-27test0926001'),(72,'test0926001',8,'test09262023-09-29test0926001');
...
-- Dump completed on 2023-09-26 22:26:09
